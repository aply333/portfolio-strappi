...
export interface ApiFrontPageIntroFrontPageIntro extends Schema.SingleType {
  collectionName: 'front_page_intros';
  info: {
    singularName: 'front-page-intro';
    pluralName: 'front-page-intros';
  ...
  attributes: {
    Intro: Attribute.Component<'landing.intro-landing'>;
    About: Attribute.Component<'landing.about'>;
    Stack: Attribute.Component<'landing.stack'>;
    Gallery: Attribute.Component<'landing.gallery'>;
    Contact: Attribute.Component<'landing.contact'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::front-page-intro.front-page-intro',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
